...
const HintBox: React.FC<HintBoxProps> = ({ message, header, setShowHint, exitButtonTitle = "Continue" }) => {
    return (
        <div className="absolute inset-0 -top-48 flex items-center justify-center">
            <div className="flex flex-col items-center justify-center min-w-[8rem] min-h-[8rem] max-w-[24rem] bg-white shadow-lg z-10 border border-gray-300 rounded-lg p-6 text-gray-700 space-y-4">
