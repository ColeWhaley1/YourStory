...
const StoryBullet: React.FC<StoryBulletProps> = ({ story }) => {
        ...
        <div className="py-4 border w-full rounded-lg shadow-md bg-white max-h-44 flex items-center space-x-6 relative">
            ...
            <div className="flex-1 min-w-0">
                <div className='mb-2'>    
                    ...
                    <div className='text-xs opacity-60'>{convertToDate(story.created_at)}</div>
                </div>
            ...
            <div className="pr-6">
                <FillButton message="See More" handleClick={() => navigate(`/stories/${story.id}`)} />
            </div>
        </div>
    );
};
